 ...
 * If stepfunction fails with total 10 minutes timeout, check if there is other problem.
 */
export class CloudfrontInvalidation extends Construct {
   ...
   constructor(scope: Construct, id: string, props: CloudfrontInvalidationProps) {
      ...
      const lambdaCloudfrontCreateInvalidation = new aws_stepfunctions_tasks.LambdaInvoke(this, 'CloudfrontCreateInvalidation', {
      ...
      const lambdaCloudfrontGetInvalidation = new aws_stepfunctions_tasks.LambdaInvoke(this, 'CloudfrontGetInvalidation', {
